...
namespace CompiPascal.interprete.instruccion
{
    class FunctionInstruccion : Instruccion
    {
        ...
        public FunctionInstruccion(string id, LinkedList<string> parametros_referencia, LinkedList<string> parametros_valor,
            string tipo_funcion_nativo_id, LinkedList<Instruccion> header_instrucciones, LinkedList<Instruccion> body_instrucciones)
        {
            this.id = id;
        ...
        {            
            ...
            {
                p_tipoFinal = new Tipo(p_tipo, entorno);
