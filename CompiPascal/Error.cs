...
namespace CompiPascal
{
    class Error
    {
        ...
        public Error(ParseTree arbol, ParseTreeNode raiz)
        {
            this.arbol = arbol;
            this.raiz = raiz;
        }
        ...
        public bool hayErrores()
        {
            ...
            if (arbol.ParserMessages.Count > 0 || raiz == null)
            {
                ...
                using (StreamWriter outputFile = new StreamWriter("C:\\Users\\eduab\\Desktop\\Compiladores 2\\CompiPascal\\CompiPascal\\output\\reporteErrores.html"))
                {
